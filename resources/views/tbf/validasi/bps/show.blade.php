    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <a type="button" href="{{ url('/tbfvalidasi/bps') }}" class="btn btn-default" data-dismiss="modal">Kembali</a>
            ...
            <div class="card-body ">
                <form method="post" action="{{ url('/tbfvalidasi/bps') }}">
                    @csrf
                                        ...
                                        @if ($tbf !== null)
                                            ...
                                            <td class="text-center">
                                                <div class="form-check">
                                                    <input @if ($tbf->status == 4 || $tbf->status == 2 || $tbf->status == 6) checked @endif
                                                        class="form-check-input" type="radio"
                                                        name="validasi{{ $tbf->tanaman_id }}" value="6">
                                                    <label class="form-check-label">
                                                        Setuju
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input @if ($tbf->status == 3) checked @endif
                                                        class="form-check-input" type="radio"
                                                        name="validasi{{ $tbf->tanaman_id }}" value="5">
                                                    <label class="form-check-label">
                                                        Revisi
                                                    </label>
                                                </div>
                                            ...
                                            <td class="text-center"><input type="text"
                                                    name="catatanBPS{{ $tbf->tanaman_id }}"
                                                    @if ($tbf->status == 3 || $tbf->status == 2 || $tbf->status == 4 || $tbf->status == 5) value="{{ $tbf->catatan_BPS }}" @endif>
                                            </td>
                                            ...
                                            <td>
                                                @if ($tbf->r3 == 0)
                                                    <button type="button" class="badge badge-danger badge-sm"
                                                        data-toggle="modal" data-target="#delete{{ $tbf->tanaman_id }}"><i
        ...
        <div class="modal fade" id="delete{{ $value->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="post" action="{{ url('/tbfvalidasi/bps/' . $value->id) }}">
                        @method('delete')
                        @csrf
                        <div class="modal-body">
