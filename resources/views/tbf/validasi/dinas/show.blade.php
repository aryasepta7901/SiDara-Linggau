    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <a type="button" href="{{ url('/tbfvalidasi/dinas') }}" class="btn btn-default"
                    data-dismiss="modal">Kembali</a>

            </div>
            <div class="card-body">
                <form method="post" action="{{ url('/tbfvalidasi/dinas') }}">
                    @csrf
                                    ...
                                    @if ($tbf !== null)
                                        ...
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input @if ($tbf->status == 4 || $tbf->status == 2) checked @endif
                                                    class="form-check-input" type="radio"
                                                    name="validasi{{ $tbf->tanaman_id }}" value="4">
                                            ...
                                            <div class="form-check">
                                                <input @if ($tbf->status == 3) checked @endif
                                                    class="form-check-input" type="radio"
                                                    name="validasi{{ $tbf->tanaman_id }}" value="3">
                                                <label class="form-check-label">
                                                    Revisi
                                                </label>
                                            </div>
                                        ...
                                        <td class="text-center"><input type="text"
                                                name="catatanDinas{{ $tbf->tanaman_id }}"
                                                @if ($tbf->status == 3 || $tbf->status == 2) value="{{ $tbf->catatan_dinas }}" @endif>
                                        </td>
