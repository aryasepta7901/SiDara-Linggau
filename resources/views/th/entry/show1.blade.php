                ...
                <form method="post" action="{{ url('/thentry') }}">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('r7') is-invalid  @enderror" id="r7"
                                    name="r7"
                                    @if ($thNow != null) value="{{ old('r7', $thNow->r7) }}" @endif
                                    step=".01" min="0"
                                    @if ($entryNow != null && $thNow != null) @if ($thNow->status == 2 || $thNow->status == 4 || $thNow->status == 6) readonly @endif
                                    @endif
                                >
                                @error('r7')
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('note') is-invalid  @enderror"
                                    id="note" name="note"
                                    @if ($thNow != null) value="{{ old('note', $thNow->note) }}" @else  value="{{ old('note') }}" @endif
                                    @if ($entryNow != null && $thNow != null) @if ($thNow->status == 2 || $thNow->status == 4 || $thNow->status == 6) readonly @endif
                                    @endif
                                >
                                @error('note')
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control  @error('r3') is-invalid  @enderror"
                                    name="r3" id="r3"
                                    @if ($thLast != null && $twNow == 1 && $thNow == null) value="{{ old('r3', $thLast->r8) }}"  
                                    @elseif($thNow != null && $twNow == 1) value="{{ old('r3', $thNow->r3) }}" 
                                    @elseif($thLast != null)  value="{{ $thLast->r8 }}" readonly @endif
                                    step=".01" min="0"
                                    @if ($entryNow != null && $thNow != null) @if ($thNow->status == 2 || $thNow->status == 4 || $thNow->status == 6) readonly @endif
                                    @endif>
                                @error('r3')
                            ...
                            <div class="row">
                                @if ($tanaman->belum_habis == 1)
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="input1" oninput="showHideInput1()"
                                                ...
                                                id="r4" name="r4"
                                                @if ($thNow != null) value="{{ old('r4', $thNow->r4) }}" @else  value="{{ old('r4') }}" @endif
                                                step=".01" min="0"
                                                @if ($entryNow != null && $thNow != null) @if ($thNow->status == 2 || $thNow->status == 4 || $thNow->status == 6) readonly @endif
                                                @endif>
                                            @error('r4')
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="input2" oninput="showHideInput2()"
                                                ...
                                                @if ($thNow != null) value="{{ old('r5', $thNow->r5) }}" @else  value="{{ old('r5') }}" @endif
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                @if ($thNow != null) value="{{ old('r6', $thNow->r6) }}" @else value="{{ old('r6') }}" @endif
                                    ...
                                    {{-- <span class=" text-info">Note: Total nilai R5, R6, dan R7 harus kufrang
                                        dari/sama dengan
                                        {{ $thLast->r9 }} ({{ $tanaman->satuan_luas }}) </span> --}}
                                    {{-- @else --}}
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('r7') is-invalid  @enderror"
                                            id="r7" name="r7"
                                            @if ($thNow != null) value="{{ old('r7', $thNow->r7) }}" @else  value="{{ old('r7') }}" @endif
                                            step=".01" min="0"
                                            @if ($entryNow != null && $thNow != null) @if ($thNow->status == 2 || $thNow->status == 4 || $thNow->status == 6) readonly @endif
                                            @endif>
                                        @error('r7')
                            ...
                            @if ($entryNow != null && $thNow != null)
                                @if ($thNow->status == 2 || $thNow->status == 4 || $thNow->status == 6)
                                    {{-- Readonly --}}
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        @if ($tanaman->belum_habis == 1)
                                            @if ($thNow->r4 != null)
                                                <div @if ($thNow->r5 != null) class="col-lg-6" @else class="col-lg-12" @endif
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            id="r9" name="r9"
                                                            value="{{ old('r9', $thNow->r9) }}" step=".01"
                                                            min="0" readonly>
                                                    </div>
                                                </div>
                                            @endif
                                            @if ($thNow->r5 != null)
                                                <div @if ($thNow->r4 != null) class="col-lg-6" @else class="col-lg-12" @endif
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            id="r10" name="r10"
                                                            value="{{ old('r10', $thNow->r10) }}" step=".01"
                                                            min="0" readonly>
                                                    </div>
                                                </div>
                                            @endif
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    id="r11" name="r11" value="{{ old('r11', $thNow->r11) }}"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="note" name="note"
                                                    value="{{ old('note', $thNow->note) }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                    ...
                    @if ($thLast->status_tanaman == 2)
                        <div class="modal-footer justify-content-between">
                            ...
                            <a type="button" href="{{ url('/thentry') }}" class="btn btn-default"
