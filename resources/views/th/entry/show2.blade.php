            ...
            <div class="card-body">
                <form method="post" action="{{ url('/thentry') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="r4" value="{{ $thNow->r4 }}">
                        <input type="hidden" name="r5" value="{{ $thNow->r5 }}">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" readonly value="{{ $thNow->r8 }}">
                                </div>
                            </div>
                        </div>
                        @if ($thNow->r4 != 0 || $thNow->r5 != 0)
                            <p class="text-center text-bold my-3">Produksi ({{ $tanaman->satuan_produksi }})</p>
                        @endif
                        <div class="row">
                            @if ($tanaman->belum_habis == 1)
                                @if ($thNow->r4 != 0)
                                    <div @if ($thNow->r5 != 0) class="col-lg-6" @else class="col-lg-12" @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('r9') is-invalid  @enderror"
                                                id="r9" name="r9"
                                                @if ($thNow->r9 != 0) value="{{ old('r9', $thNow->r9) }}" @else  value="{{ old('r9') }}" @endif
                                                step=".01" min="0">
                                            @error('r9')
                                ...
                                @endif
                                @if ($thNow->r5 != 0)
                                    <div @if ($thNow->r4 != 0) class="col-lg-6" @else class="col-lg-12" @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('r10') is-invalid  @enderror"
                                                id="r10" name="r10"
                                                @if ($thNow->r10 != 0) value="{{ old('r10', $thNow->r10) }}" @else  value="{{ old('r10') }}" @endif
                                                step=".01" min="0">
                                            @error('r10')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                        ...
                        @if ($thNow->r4 != 0 || $thNow->r5 != 0)
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('r11') is-invalid  @enderror"
                                    id="r11" name="r11"
                                    @if ($thNow->r11 != 0) value="{{ old('r11', $thNow->r11) }}" @else  value="{{ old('r11') }}" @endif
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('note') is-invalid  @enderror" id="note"
                                name="note" value="{{ old('note', $thNow->note) }}">
                            @error('note')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="modal-footer justify-content-between">
                        <a type="button" href="{{ url('/thentry/pertLuas/' . $tanaman->id) }}" class="btn btn-default"
